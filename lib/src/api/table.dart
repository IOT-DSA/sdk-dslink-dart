...
class SingleRowTable extends Table {
  ...
  SingleRowTable(this.columns, this.values, {String tableName})
...
class SimpleTable extends Table {
  ...
  @override
  bool getBoolean(int column) {
    return values[current][names[column]].toBoolean();
  }
  ...
  @override
  dynamic getColumnPrimitive(int column) {
    return values[current][names[column]].toPrimitive();
  }

  @override
  double getDouble(int column) {
    return values[current][names[column]].toDouble();
  }

  @override
  int getInteger(int column) {
    return values[current][names[column]].toInteger();
  }

  @override
  String getString(int column) {
    return values[current][names[column]].toString();
  }

  @override
  bool isNull(int column) {
    return values[current][names[column]] == null || values[current][names[column]].isNull;
  }
