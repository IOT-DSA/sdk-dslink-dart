...
class BrowserECDHLink implements ClientLink {
  ...
  void connect() {
    ...
    HttpRequest.request(connUri.toString(), method: 'POST', withCredentials: true, mimeType: 'application/json', sendData: JSON.encode(requestJson)).then((HttpRequest request) {
